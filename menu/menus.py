...
class BuildMenu(Menu):
    def __init__(self, x, y):
        ...
        """
        self._buttons = [Button(RAPID_TEST_BTN_IMAGE, "rapid test", self.rect.centerx, self.rect.centery + 75), Button(ALCOHOL_BTN_IMAGE, "alcohol", self.rect.centerx, self.rect.centery - 73),Button(PCR_BTN_IMAGE,"pcr",self.rect.centerx-65,self.rect.centery+10)]
